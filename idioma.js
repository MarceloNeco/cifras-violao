...
pt: {
  ...
  /* menu ☰ (gaveta) e barra de baixo */
  'menu.titulo': 'Menu',
  'menu.fechar': 'Fechar o menu',
  'menu.atalhos': 'Atalhos',
  'menu.tocar': 'Tocar',
  'menu.trazer': 'Trazer cifras',
  'menu.ajustes': 'Ajustes',
  'menu.ajuda': 'Ajuda e mais',
  'menu.cifras': 'Minhas cifras',
  'menu.acordes': 'Dicionário de acordes',
  'menu.afinador': 'Afinador',
  'menu.importar': 'Importar cifra',
  'menu.foto': 'Foto vira cifra',
  'menu.tema': 'Tema claro ou escuro',
  'menu.fundo': 'Imagem de fundo',
  'menu.instalar': 'Instalar o app',
  'menu.assistone': 'AssistONE (ajuda)',
  'menu.novidades': 'Novidades',
  'menu.aviso': 'Aviso legal',
  'menu.portal': 'Portal SolverONE',
  'barra.inicio': 'Início',
  'barra.acordes': 'Acordes',
  'barra.importar': 'Importar',
  'barra.foto': 'Foto',
  'anuncio.tag': 'Anúncio',
  'anuncio.breve': 'em breve',
  'anuncio.fechaEm': 'Pode fechar em {n} s',
  'anuncio.podeFechar': 'Pode fechar',
  'anuncio.conhecer': 'Conhecer',
  ...
  'inicio.sub': 'Busque por música, artista ou trecho da letra.',
  ...
  'cifra.voz': 'Ler a letra em voz alta',
  'cifra.vozParar': 'Parar a leitura',
  'cifra.semVoz': 'Este navegador não tem leitura em voz alta.',
  ...
  'cifra.palcoTexto': ' Modo celular',
  'cifra.mais': 'Mais comandos',
  'cifra.comandos': 'Comandos da cifra',
  'cifra.comandosFrase': 'Tudo o que você precisa enquanto toca. Toque na letra para ver a barra de baixo.',
...
en: {
  ...
  'menu.titulo': 'Menu',
  'menu.fechar': 'Close the menu',
  'menu.atalhos': 'Shortcuts',
  'menu.tocar': 'Play',
  'menu.trazer': 'Bring in charts',
  'menu.ajustes': 'Settings',
  'menu.ajuda': 'Help and more',
  'menu.cifras': 'My chords',
  'menu.acordes': 'Chord dictionary',
  'menu.afinador': 'Tuner',
  'menu.importar': 'Import chart',
  'menu.foto': 'Photo to chart',
  'menu.tema': 'Light or dark theme',
  'menu.fundo': 'Background image',
  'menu.instalar': 'Install the app',
  'menu.assistone': 'AssistONE (help)',
  'menu.novidades': "What's new",
  'menu.aviso': 'Legal notice',
  'menu.portal': 'SolverONE Portal',
  'barra.inicio': 'Home',
  'barra.acordes': 'Chords',
  'barra.importar': 'Import',
  'barra.foto': 'Photo',
  'anuncio.tag': 'Ad',
  'anuncio.breve': 'soon',
  'anuncio.fechaEm': 'You can close in {n} s',
  'anuncio.podeFechar': 'You can close it now',
  'anuncio.conhecer': 'Take a look',
  ...
  'inicio.sub': 'Search by song, artist or a line of the lyrics.',
  ...
  'cifra.voz': 'Read the lyrics aloud',
  'cifra.vozParar': 'Stop reading',
  'cifra.semVoz': 'This browser cannot read aloud.',
  ...
  'cifra.palcoTexto': ' Phone mode',
  'cifra.mais': 'More commands',
  'cifra.comandos': 'Chart commands',
  'cifra.comandosFrase': 'Everything you need while you play. Tap the lyrics to bring the bottom bar back.',
